...
public class DwarvenRevolver extends AbstractGun{
    ...
    private static final float FIRE_RATE = 1.5f;

    public DwarvenRevolver() {
    ...
    public void shootEffects(Level level, Player player, ItemStack gun, Item round){
        //recoil on fire anim
        forceAnimation(gun, 1, level.getGameTime(), 5);
        level.playSound(null, player.getX(), player.getY(), player.getZ(),
                ModSounds.RIFLE_SHOOT.get(), SoundSource.PLAYERS, 1.0F, 1.5F);
    }
}
